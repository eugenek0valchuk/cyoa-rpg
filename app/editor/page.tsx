  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black px-6 text-[#e7e2dc]">
      ...
      <section className="relative z-10 mx-auto max-w-[1100px] pt-[6vh] pb-12">
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          ...
          >
            <img
              ...
              alt="Previous"
              className="h-[64px] w-[64px] object-contain transition duration-300 hover:drop-shadow-[0_0_10px_rgba(142,31,31,0.8)]"
            />
          </button>
        ...
        <div className="relative mx-auto mt-6 max-w-[620px] overflow-hidden">
          <div
              ...
              <div key={origin.value} className="min-w-full shrink-0">
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <h2 className="font-cinzel mt-2 text-3xl uppercase tracking-[0.14em] text-[#e4d8cf]">
                      {origin.title}
                    </h2>

                    <p className="mt-1 text-[13px] text-[#9d8d82]">
                      {origin.subtitle}
                    </p>

                    <div className="mt-4 grid grid-cols-3 gap-2 text-[12px] text-[#d8c9be]">
