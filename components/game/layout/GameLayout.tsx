...
export function GameLayout({ children }: Props) {
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-black text-[#e7ded7]">
      <img
        src="/main-bg.png"
        alt=""
      ...
      <section className="relative z-10 mx-auto flex min-h-screen max-w-[980px] flex-col px-4 py-5 sm:px-6 sm:py-6">
        {children}
      </section>
    </main>
  )
