    ...
    <>
      ...
      {open &&
        ...
        createPortal(
          <div
            role="tooltip"
            className={`pointer-events-none fixed ${zLayers.tooltip} w-max max-w-[260px] -translate-x-1/2 -translate-y-full border border-[#3b2a2a] bg-[#0d0909]/98 px-3 py-2 shadow-[0_8px_28px_rgba(0,0,0,0.7)]`}
