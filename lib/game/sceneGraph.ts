...
> = {
  ...
  encounter_procession_herald: { x: 1, y: 0, zone: 'event', label: 'Вестник' },
  procession_herald_answer: { x: 1, y: 1, zone: 'event' },
  encounter_ash_weaver: { x: 2, y: 3, zone: 'event', label: 'Пепел' },
  encounter_mirror_nun: { x: 2, y: 0, zone: 'event', label: 'Зеркало' },
  encounter_iron_keeper: { x: 0, y: 5, zone: 'event', label: 'Железо' },
  encounter_vein_prophet: { x: 0, y: 8, zone: 'event', label: 'Жила' },
